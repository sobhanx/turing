...
MODEL_TITLES: dict[str, tuple[str, str]] = {
    ...
    "TranscriptExportSettings": ("تنظیمات خروجی متن", "تنظیمات خروجی متن"),
    "Organization": ("سازمان", "سازمان‌ها"),
    "TuringMembership": ("عضویت", "عضویت‌ها"),
    "Meeting": ("جلسه", "جلسات"),
    "Recording": ("ضبط", "ضبط‌ها"),
...
FIELD_LABELS: dict[str, str] = {
    ...
    "notes": "یادداشت",
    "show_meeting_title": "عنوان جلسه",
    "show_persian_date": "تاریخ شمسی",
    "show_gregorian_date": "تاریخ میلادی",
    "show_duration": "مدت زمان",
    "show_speakers": "گویندگان",
    "show_full_transcript": "متن کامل",
    "show_timeline": "برچسب زمانی",
    "show_ai_summary": "خلاصه اجرایی",
    "show_key_topics": "موضوعات کلیدی",
    "show_action_items": "اقدامات",
    "show_decisions": "تصمیم‌ها / نکات کلیدی",
    "show_keywords": "کلیدواژه‌ها",
    "show_provider": "ارائه‌دهنده گفتار (داخلی)",
    "is_global": "سراسری",
    "slug": "نامک",
...
FIELD_HELP: dict[str, str] = {
    ...
    "show_ai_summary": "بخش خلاصه اجرایی هوش مصنوعی را در خروجی PDF و DOCX نشان بده.",
    "show_key_topics": "فهرست موضوعات کلیدی را در خروجی PDF و DOCX نشان بده.",
    "show_action_items": "اقدامات پیشنهادی هوش مصنوعی را در خروجی PDF و DOCX نشان بده.",
    "show_decisions": (
        "تصمیم‌ها و نکات کلیدی (از نقاط اصلی خلاصه) را در خروجی PDF و DOCX نشان بده."
    ),
    "show_keywords": "تراشه‌های کلیدواژه (برگرفته از موضوعات) را در خروجی PDF و DOCX نشان بده.",
    "show_provider": (
        "کد ارائه‌دهنده رونویسی را در اطلاعات جلسه نشان بده. "
        "معمولاً برای اسناد کاربر نهایی خاموش بگذارید."
    ),
}
